...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:me="http://www.menota.org/ns/1.0"
    ...
    <!-- Version of stylesheet: 27 February 2020 -->
    
    <!-- The authors of this stylesheet have agreed on the 15th August 2017 to make it available under a CC BY 4.0 license. -->
...
<xsl:template match="tei:lb|lb"> 
    ...
    <xsl:choose>
        ...
        <xsl:when test="contains($visning, 'facs') and not(attribute::n)">                          
            <!-- new by BS for Menota 3.0: add middot if hyphenation needs to be supplied -->
            <xsl:if test="not(preceding-sibling::*[1][self::tei:c/attribute::type='hyphen'])"><xsl:text>&#x00B7;</xsl:text></xsl:if> <!-- add middot to supply hyphen if not present -->
            <xsl:element name="SPAN">
        ...
        <!-- New by BS: rearrange order of w, num, pc and me:punct in lines with @rend -->
          <xsl:if test="attribute::rend">       
              ...
              <xsl:variable name="line-seg-1"> <!--  variable for first part of the line -->
                  ...
                  <xsl:for-each select="//tei:w[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']|//tei:pc[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']">
              ...
              <xsl:variable name="line-seg-2">
                  ...
                  <!-- get the complete words -->
                  <xsl:for-each select="//tei:w[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2']|//tei:pc[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2']">
                      <xsl:choose>
                          <xsl:when test="ancestor::tei:head">
                              <xsl:element name="tei:head">
                                  <xsl:attribute name="type">rend_variable</xsl:attribute>
              ...
              <xsl:variable name="line-seg-3">
                  ...
                  <xsl:for-each select="//tei:w[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3']">
                      <xsl:choose>
                          <xsl:when test="ancestor::tei:head">
                              <xsl:element name="tei:head">
                                  <xsl:attribute name="type">rend_variable</xsl:attribute>
              ...
              <xsl:variable name="line-seg-4">
                  ...
                  <!-- get the complete words -->
                  <!--  if part of header than wrap in <head> markup -->
                  <xsl:for-each select="//tei:w[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4']|//me:punct[preceding::tei:pb[1][attribute::n=$preceding-pb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4']">
                      <xsl:choose>
                          <xsl:when test="ancestor::tei:head">
                              <xsl:element name="tei:head">
                                  <xsl:attribute name="type">rend_variable</xsl:attribute>
              ...
              <xsl:apply-templates select="$line-seg-4" mode="rend"/>
                  ...
                  <xsl:otherwise>  <!-- for multi-column manuscripts -->
                      ...
                      <xsl:variable name="line-seg-A">
                          ...
                          <!-- get the complete words -->
                          <!-- if part of header than wrap in <head> markup -->
                          <xsl:for-each select="//tei:w[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']|//me:punct[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']|//tei:pc[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='1']">
                              <xsl:choose>
                                  <xsl:when test="ancestor::tei:head">
                                      <xsl:element name="tei:head">
                                          <xsl:attribute name="type">rend_variable</xsl:attribute>
                      ...
                      <xsl:variable name="line-seg-B">
                          ...
                          <!-- get the complete words -->
                          <!-- if part of header than wrap in <head> markup -->
                          <xsl:for-each select="//tei:w[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2']|//me:punct[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='2']">
                              <xsl:choose>
                                  <xsl:when test="ancestor::tei:head">
                                      <xsl:element name="tei:head">
                                          <xsl:attribute name="type">rend_variable</xsl:attribute>
                      ...
                      <xsl:variable name="line-seg-C">
                          ...
                          <!-- get the complete words -->
                          <!-- if part of header than wrap in <head> markup -->
                          <xsl:for-each select="//tei:w[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3']|//me:punct[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='3']">
                              <xsl:choose>
                                  <xsl:when test="ancestor::tei:head">
                                      <xsl:element name="tei:head">
                                          <xsl:attribute name="type">rend_variable</xsl:attribute>
                      ...
                      <xsl:variable name="line-seg-D">
                          ...
                          <!-- get the complete words -->
                          <!-- if part of header than wrap in <head> markup -->
                          <xsl:for-each select="//tei:w[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4'][not(descendant::tei:lb[attribute::rend])]|//tei:num[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4']|//me:punct[preceding::tei:cb[1][attribute::n=$preceding-cb]][preceding::tei:lb[1]/attribute::n=$line][preceding::tei:lb[1]/attribute::rend='4']">
                              <xsl:choose>
                                  <xsl:when test="ancestor::tei:head">
                                      <xsl:element name="tei:head">
                                          <xsl:attribute name="type">rend_variable</xsl:attribute>
...
<!-- Since spaces inside p elements are stripped from the file (see general comment at the start of the stylesheet), a function has been created within this template to generate spaces after individual words, but not before punctuation marks. -->    
    ...
    <xsl:template match="me:punct | tei:pc | punct" mode="#all">  <!-- adjusted by BS 6/3 2017 -->
        <xsl:choose>
            ...
            <xsl:when test="preceding::tei:lb[1]/attribute::rend"></xsl:when> <!-- new by BS -->
            <xsl:otherwise>
                <xsl:apply-templates/>
                <xsl:choose>
